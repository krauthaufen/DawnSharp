...
Target.create "LinkDawnWindows" (fun _ ->
    ...
    //let files = ["glfw3.lib"]
    //for f in files do
    //    let src = Path.Combine(__SOURCE_DIRECTORY__, "lib", "glfw3.lib")
    //    let dst = Path.Combine(dawnDir, "cmake", "third_party", "glfw", "src", "Release")
    ...
    let linkResult = 
        ...
        let lib (str : string) =
            ...
            else failwithf "file not found: %s" str
        ...
        let linkerArgs =
            [
                ...
                Path.Combine(__SOURCE_DIRECTORY__, "lib", "glfw.lib") |> lib
                ...
                "/manifest:embed"
                "/DEBUG"
                sprintf "/PDB:\"%s\"" (Path.ChangeExtension(dllOut, ".pdb"))
                "/SUBSYSTEM:WINDOWS"
                "/OPT:NOREF"
                "/OPT:ICF"
                "/LTCG"
...
Target.create "CleanDawnWindows" (fun _ ->
    // clean checkout dawn
...
Target.create "BuildDawnWindows" (fun _ ->
    // cmake . -B cmake
...
"CleanDawnWindows" ?=> "BuildDawnWindows"
"BuildDawnWindows" ?=> "LinkDawnWindows"


"CleanDawnWindows" ==> "CreatePackage"
"BuildDawnWindows" ==> "CreatePackage"
"LinkDawnWindows" ==> "CreatePackage"
